...
354 POKE 36878, 15
355 F OR X = 255 TO 128 STEP - 1
356 POKE 36877, X
357 F OR DE = 1 TO 20: NEXT DE
358 POKE 36874, X
359 NEXT X
360 F OR X = 15 TO 0 STEP - 1 : F OR Y = 1 TO 20: NEXT Y: POKE 36878, X: NEXT X
361 GOTO 372
...
398 NEXT X
399 RETURN
400 DATA DR ON E, 'DROID, HUMANOID, MACHINE, DR ON E, ROBOT, PUMP
401 DATA COMPASS, BOMB, MEM OR Y, PROCESS OR, TAPE
402 DATA BOOK, SERVO, TO OL KIT, CLOCK, BRACE LET, MAT CHES, SCREWDRIVER
403 DATA BLASTER, MASK, ROPE, MAGNET, FUSE, N OR TH
404 DATA SOUTH
405 DATA WEST, EAST, TRANS MAT, APE, LOOK, LIST, QUIT, TAKE
